...
export const messages = sqliteTable('messages', {
  parentMessageId: integer('parent_message_id').references((): AnySQLiteColumn => messages.id, { onUpdate: 'cascade', onDelete: 'cascade' }),
  authorId: integer('author_id').notNull().references(() => users.id, { onUpdate: 'cascade', onDelete: 'cascade' }),
  id: integer('id').primaryKey({ autoIncrement: true }),
